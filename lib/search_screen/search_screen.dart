        ...
        appBar: AppBar(
          ...
          title: Container(
              ...
              decoration: BoxDecoration(
                  color: const Color.fromARGB(255, 216, 195, 195),
                ...
                child: Obx(() {
                  return TextFormField(
                    ...
                    onChanged: (value) {
                      ...
                      for (var i = 0;
                          i < homeController.getResult.length;
                          i++) {
                        if (homeController.getResult[i].paragraph != null &&
                            homeController
                                .getResult[i].paragraph!.richText!.isNotEmpty &&
                            homeController.getResult[i].paragraph!.richText!
                                .first.plainText
                                .toString()
                                .toLowerCase()
                                .contains(controller.searchController.value.text
                                    .toLowerCase())) {
                          controller.heading.value = homeController
                              .getResult[i].paragraph!.richText![0].plainText
                              .toString();
                          print(controller.heading.value);
                          controller.content.value = homeController
                              .getResult[i].paragraph!.richText![0].plainText
                              .toString();
                          controller.dateandTime.value = homeController
                              .getResult[i].paragraph!.richText![0].plainText
                              .toString();
                          controller.image.value =
                              homeController.getResult[i].image?.file?.url ??
                                  "";
