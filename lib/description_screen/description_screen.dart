  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
            ...
            //  title:const Text('Hi, Andi Loshi'),
                ...
                child: Obx(
                   () {
                    return Column(
                      ...
                      children: [
                        Padding(
                          padding: EdgeInsets.fromLTRB(20.sp, 10.sp, 20.sp, 10),
                          child: Text(
                              // 'When Stars Come Knocking: Prepare for Unforgettable Experience',
                              controller.getResult[1].paragraph?.richText![0].plainText
                                      .toString() ??
                                  "",
                              style: Styles.medium15Bld),
                        ),
                        Padding(
                          padding: EdgeInsets.only(right: 10.0.sp, bottom: 10.sp),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.end,
                            children: [
                              GestureDetector(
                                onTap: () async {
                                  final Uri url = controller.paramsValue.value ==
                                          "(Star)"
                                      ? Uri.parse(controller
                                          .getResult[18].video!.imageExternal!.url
                                          .toString())
                                      : Uri.parse(
                        ...
                        Padding(
                          padding: EdgeInsets.fromLTRB(20.sp, 10, 20.sp, 10.sp),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(
                                  ...
                                  controller.getResult[6].paragraph?.richText![0]
                                          .plainText
                                          .toString() ??
                                      "",
                                  style: Styles.normal),
                              ...
                              // Text(
                              //     // 'Lorem ipsum dolor sit amet consectetur. Nulla mi faucibus nam faucibus adipiscing nec tempor mauris nulla. Lorem ipsum dolor sit amet consectetur. Nulla mi faucibus nam faucibus adipiscing nec tempor mauris nulla. Lorem ipsum dolor sit amet consectetur. Nulla mi faucibus nam faucibus adipiscing nec tempor mauris nulla. Lorem ipsum dolor sit amet consectetur. Nulla mi faucibus nam faucibus adipiscing nec tempor mauris nulla.Lorem ipsum dolor sit amet consectetur. Nulla mi faucibus nam faucibus adipiscing nec tempor mauris nulla.',
                              //      controller.getResult[6].paragraph?.richText![0].plainText.toString() ??
                              // "",
                              ...
                              Text(
                                  ...
                                  controller.paramsValue.value == "(Star)"
                                      ? controller.getResult[13].paragraph?.richText![0]
                                              .plainText
                                              .toString() ??
                                          ""
                                      : controller.getResult[7].paragraph?.richText![0]
                                              .plainText
                                              .toString() ??
                                          "",
                                  style: Styles.normal),
                              ...
                              Text(
                                  ...
                                  controller.paramsValue.value == "(Star)"
                                      ? controller.getResult[15].paragraph?.richText![0]
                                              .plainText
                                              .toString() ??
                                          ""
                                      : controller.getResult[8].paragraph?.richText![0]
                                              .plainText
                                              .toString() ??
                                          "",
                                  style: Styles.normal),
                              ...
                              Text(
                                  ...
                                  controller.paramsValue.value == "(Star)"
                                      ? controller.getResult[16].paragraph?.richText![0]
                                              .plainText
                                              .toString() ??
                                          ""
                                      : controller.getResult[12].paragraph?.richText![0]
                                              .plainText
                                              .toString() ??
                                          "",
                                  style: Styles.normal),
                                        ...
                                        children: [
                                          recommanded(
                                              homeController
                                                      ...
                                                      ?.toString() ??
                                                  "",
                                              homeController.getResult[4].paragraph
                                                      ?.richText?.first.plainText
                                                      .toString() ??
                                                  "",
                                              homeController.getResult[5].paragraph
                                                      ?.richText?.first.plainText
                                                      .toString() ??
                                                  ""),
                                          recommanded(
                                              homeController
                                                      .getResult[8].image?.file?.url
                                                      ?.toString() ??
                                                  "",
                                              homeController.getResult[9].paragraph
                                                      ?.richText?.first.plainText
                                                      .toString() ??
                                                  "",
                                              homeController.getResult[5].paragraph
