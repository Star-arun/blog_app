                    ...
                    child: Obx(() {
                      return Column(
                        ...
                        children: [
                          Obx(() {
                            return Text(
                              controller.getResult[1].paragraph != null
                                  ? controller.getResult[1].paragraph?.richText
                                          ?.first.plainText
                                          .toString() ??
                                      ""
                                  : "",
  ...
  Column dashboardWidget() {
    ...
    return Column(
      ...
      children: [
        ...
        Text(
            controller.getResult[4].paragraph != null
                ? controller.getResult[4].paragraph?.richText?.first.plainText
                        .toString() ??
                    ""
                : "",
        ...
        Text(
            controller.getResult[5].paragraph != null
                ? controller.getResult[5].paragraph?.richText?.first.plainText
                        .toString() ??
                    ""
                : "",
            style: Styles.normal),
        ...
        Text(
            controller.getResult[6].paragraph != null
                ? controller.getResult[6].paragraph?.richText?.first.plainText
                        .toString() ??
                    ""
                : "",
            style: Styles.normal),
        ...
        Text(
            controller.getResult[9].paragraph != null
                ? controller.getResult[9].paragraph?.richText?.first.plainText
                        .toString() ??
                    ""
                : "",
            style: Styles.medium15Bld),
